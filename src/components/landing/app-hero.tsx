...
/**
 * The /evermore-app page's own hero — same bg-brand-gradient / breadcrumb / eyebrow language as
 * the shared PageHeader (which this replaces on that page only), but two-column so the copy can
 * sit next to a live preview of the installed app instead of standing alone.
 */
        ...
        <div>
          ...
          <Reveal delay={0.05}>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <Button href="#install-guide" variant="outline" size="lg">
                See install steps
              </Button>
            </div>
          </Reveal>
