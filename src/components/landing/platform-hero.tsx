...
import { PlatformHubMockup } from "./platform-hub-mockup";

const EASE = [0.16, 1, 0.3, 1] as const;

/**
 * The /evermore-platform page's own hero — same bg-brand-gradient / breadcrumb / eyebrow language
 * as the shared PageHeader (which this replaces on that page only), but two-column so the copy
 * sits next to a preview of the member dashboard that ties the platform's six pillars together
 * (see PlatformHubMockup).
 */
export function PlatformHero({
  ...
  return (
    <section className="bg-brand-gradient relative overflow-hidden pb-16 pt-10 text-white sm:pb-20 sm:pt-14">
      ...
      <Container className="relative grid grid-cols-1 items-center gap-14 lg:grid-cols-[0.95fr_1.05fr] lg:gap-10">
        <div>
          ...
          <Reveal delay={0.05}>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <Button href="#platform-features" variant="outline" size="lg">
